...
public class BitacoraRegistro implements Serializable {
    ...
    /* @Column(name="df_fechahora_evento", nullable=false)
    private LocalDateTime dfFechahoraEvento; */
     ...
     */
    /* public LocalDateTime getDfFechahoraEvento() {
        return dfFechahoraEvento;
    } */
     ...
     */
    /* public void setDfFechahoraEvento(LocalDateTime aDfFechahoraEvento) {
        dfFechahoraEvento = aDfFechahoraEvento;
    } */
