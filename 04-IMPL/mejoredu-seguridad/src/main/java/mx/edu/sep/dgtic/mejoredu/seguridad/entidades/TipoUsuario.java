...
public class TipoUsuario implements Serializable {
    ...
    /**
     * Compares the key for this instance with another TipoUsuarioVO.
     *
     * @param other The object to compare to
     * @return True if other object is instance of class TipoUsuarioVO and the key objects are equal
     */
    private boolean equalKeys(Object other) {
        if (this==other) {
            return true;
        }
        if (!(other instanceof TipoUsuario that)) {
            return false;
        }
        return this.getIdTipoUsuario() == that.getIdTipoUsuario();
    }

    /**
     * Compares this instance with another TipoUsuarioVO.
     *
     * @param other The object to compare to
    ...
    public String toString() {
        String sb = "[TipoUsuarioVO |" + " idTipoUsuario=" + getIdTipoUsuario() +
                "]";
        return sb;
    }
