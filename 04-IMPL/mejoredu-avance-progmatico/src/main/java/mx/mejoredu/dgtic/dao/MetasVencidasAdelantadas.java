...
import mx.edu.sep.dgtic.mejoredu.seguimiento.CalendarioProductosProgramadosVO;
import mx.edu.sep.dgtic.mejoredu.seguimiento.calendarioProductosEntregados;
...
@Data
public class MetasVencidasAdelantadas {
	...
	private List<ArchivoBase> archivo = new ArrayList<>();
}
