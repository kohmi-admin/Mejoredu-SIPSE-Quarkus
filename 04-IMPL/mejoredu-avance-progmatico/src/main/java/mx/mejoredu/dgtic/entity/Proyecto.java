...
public class Proyecto {
    ...
    private Set<CortoplazoActividad> actividad = new HashSet<>();

    @OneToMany(mappedBy = "proyectoModificacion")
    private Set<AdecuacionProyecto> adecuacionProyecto = new HashSet<>();
    @OneToMany(mappedBy = "proyectoReferencia")
    private Set<AdecuacionProyecto> adecuacionProyectoReferencia = new HashSet<>();
    /**
