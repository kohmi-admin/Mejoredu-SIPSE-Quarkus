...
import mx.sep.dgtic.mejoredu.seguimiento.dao.AnhoPlaneacionRespository;
import mx.sep.dgtic.mejoredu.seguimiento.dao.ArchivoRepository;
import mx.sep.dgtic.mejoredu.seguimiento.dao.FormularioAnaliticoRepository;
...
public class FormularioAnaliticoServiceImpl implements FormularioAnaliticoService {
  ...
  public Set<ArchivoVO> listarArchivos(Long idFormulario) {
    ...
    return formularioAnaliticoRepository.listarArchivos(idFormulario).stream().map(it -> {
      ...
      vo.setCxNombre(it.getNombre());
      vo.setCxUuid(it.getUuid());
      ...
      vo.setDfFechaCarga(it.getFechaCarga());
      vo.setDfHoraCarga(it.getHoraCarga());
      vo.setCsEstatus(it.getEstatus());
      vo.setCveUsuario(it.getUsuario().getCveUsuario());
      return vo;
  ...
  public ArchivoVO agregarArchivo(Long idFormulario, RegistroArchivoVO registroArchivo) {
    ...
    vo.setCxNombre(archivo.getNombre());
    vo.setCxUuid(archivo.getUuid());
    ...
    vo.setTipoDocumento(tipoDocumento);
    vo.setDfFechaCarga(archivo.getFechaCarga());
    vo.setDfHoraCarga(archivo.getHoraCarga());
    vo.setCsEstatus(archivo.getEstatus());
