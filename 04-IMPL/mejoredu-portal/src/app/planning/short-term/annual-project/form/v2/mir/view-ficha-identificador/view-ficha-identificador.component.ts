...
@Component({
  selector: 'app-view-ficha-identificador',
  templateUrl: './view-ficha-identificador.component.html',
  styleUrls: ['./view-ficha-identificador.component.scss'],
})
export class ViewFichaIdentificadorComponent {
  form!: FormGroup;
  ...
  constructor(
    public dialogRef: MatDialogRef<ViewFichaIdentificadorComponent>,
  ...
  consultarFicha() {
    this.p016MirService
      .consultarFicha(this.dataMatriz.idIndicadorMP || 0)
      .subscribe({
        next: (value) => {
