...
public class ProyectoContribucion implements Serializable {
    ...
    private CatMasterCatalogo contribucion;
    @ManyToOne(optional=false)
     ...
     */
    public ProyectoAnual getProyectoAnual() {
     ...
     */
    public void setProyectoAnual(ProyectoAnual aMetCortoplazoProyecto) {
     ...
     */
    public CatMasterCatalogo getContribucion() {
        return contribucion;
    }
     ...
     */
    public void setContribucion(CatMasterCatalogo pContribucion) {
