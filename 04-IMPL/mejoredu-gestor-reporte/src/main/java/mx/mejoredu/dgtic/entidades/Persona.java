...
public class Persona implements Serializable {
	...
	@Column(name = "cx_nombre", nullable = false, length = 120)
	private String cxNombre;
	@Column(name = "cx_primer_apellido", nullable = false, length = 120)
	private String cxPrimerApellido;
	@Column(name = "cx_segundo_apellido", length = 120)
	private String cxSegundoApellido;
	@Column(name = "df_fecha_nacimiento", nullable = false)
	private LocalDate dfFechaNacimiento;
	@Column(name = "cx_correo", nullable = false, length = 120)
	 ...
	 * @return True if other object is instance of class Persona and the key objects
	 *         are equal
	 */
